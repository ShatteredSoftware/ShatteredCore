...
import com.github.shatteredsuite.core.data.generic.EmptyDataStore
...
abstract class CommandContext(val messageProcessorStore: MessageProcessorStore, var data: DataStore = EmptyDataStore, val debug: Boolean = false) {
